...
export const ru = {
  ...
  "set.autoSelect": "Выбирать самый быстрый сервер",
  "set.autoSelectDesc":
    "Ядро само переключается на сервер с наименьшей задержкой и перепроверяет раз в 3 минуты.",
  ...
  "set.autostart": "Запускать вместе с Windows",
  ...
  "split.showSystemProcs": "Показывать системные процессы Windows",
