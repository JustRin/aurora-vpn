...
export const ru = {
  ...
  "srv.pasteBtn": "Вставить",
  "srv.clipboardEmpty": "В буфере обмена нет текста",
  "srv.pasteFailed": "Не удалось прочитать буфер обмена",
  ...
  "srv.warpEndpointHint": "Точка входа Cloudflare — адрес и порт выше. Если порт закрыт в сети, попробуйте 500, 854, 955 или 4500.",

  // --------------------------------------------------------------------- warp
  "warp.title": "Дополнительная защита через WARP",
  "warp.desc": "Трафик идёт через выбранный сервер и дальше через Cloudflare WARP. Сервер должен пропускать UDP.",
  "warp.working": "Применяем…",
  "warp.enabled": "WARP включён",
  "warp.consentTitle": "Включить Cloudflare WARP",
  "warp.consentText": "WARP — бесплатный WireGuard от Cloudflare. Приложение зарегистрирует анонимное устройство: ни учётной записи, ни оплаты это не требует. Включая, вы соглашаетесь с условиями Cloudflare.",
  "warp.terms": "Условия использования",
  "warp.privacy": "Политика конфиденциальности",
  "warp.accept": "Согласен, включить",
  "warp.registerFailed": "Не удалось зарегистрировать WARP",
  "warp.linkCopied": "Ссылка скопирована",
  "warp.account": "Аккаунт Cloudflare",
  "warp.accountOn": "зарегистрирован, тариф {type}",
  "warp.accountOff": "не зарегистрирован — появится при первом включении WARP",
  "warp.newAddress": "Сменить адрес",
  "warp.newAddressHint": "Новая регистрация: другой ключ и другой адрес на выходе",
  "warp.resetDone": "WARP перерегистрирован",
  "warp.resetFailed": "Не удалось перерегистрировать WARP",

  // ----------------------------------------------------------------------- qr
  "qr.scan": "Считать QR-код:",
  "qr.screen": "Экран",
  "qr.file": "Файл",
  "qr.camera": "Камера",
  "qr.title": "QR-код",
  "qr.hint": "Наведите камеру на код — он прочитается сам.",
  "qr.overlayScan": "Считать",
  "qr.overlayHint": "Откройте код на экране",
  "qr.overlayDone": "Готово",
  "qr.starting": "Включаем камеру…",
  "qr.denied": "Доступ к камере запрещён — разрешите его в настройках системы.",
  "qr.noCamera": "Камера не найдена.",
  "qr.cameraFailed": "Не удалось включить камеру.",
  "qr.switch": "Другая камера",
  "qr.expand": "Развернуть",
  "qr.collapse": "Свернуть",
  "qr.foundOne": "Код прочитан",
  "qr.foundMany": "Прочитано кодов: {n}",
  "qr.nothing": "QR-код не найден",
  "qr.screenFailed": "Не удалось снять экран",
  "qr.fileFailed": "Не удалось прочитать картинку",
