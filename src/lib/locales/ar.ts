...
export const ar: Record<keyof typeof ru, string> = {
  ...
  "pick.balancers": "الموازنات",
  "pick.servers": "الخوادم",
  "pick.badgeBackup": "خادم احتياطي",
  "pick.now": "الآن: {name}",
  "pick.nowChip": "الآن",
  "pick.primary": "الأساسي: {name}",
  "pick.primaryDown": "الأساسي لا يستجيب",
  "pick.failoverMeta": "خادم أساسي وبديل ريثما يصمت",
  "pick.fastestMeta": "حسب الزمن، دون تأرجح بين المتقاربين",
  "pick.rotateMeta": "الخادم الحي التالي في كل جولة",
  ...
  "srv.pasteBtn": "لصق",
  "srv.clipboardEmpty": "لا يوجد نص في الحافظة",
  "srv.pasteFailed": "تعذّرت قراءة الحافظة",
  ...
  "srv.warpEndpointHint": "نقطة دخول Cloudflare هي العنوان والمنفذ أعلاه. إن كان المنفذ محجوبًا في شبكتك، جرّب 500 أو 854 أو 955 أو 4500.",

  // --------------------------------------------------------------------- warp
  "warp.title": "حماية إضافية عبر WARP",
  "warp.desc": "تمر البيانات عبر الخادم المختار ثم عبر Cloudflare WARP. على الخادم أن يمرّر UDP.",
  "warp.working": "جارٍ التطبيق…",
  "warp.enabled": "تم تشغيل WARP",
  "warp.consentTitle": "تشغيل Cloudflare WARP",
  "warp.consentText": "WARP خدمة WireGuard مجانية من Cloudflare. يسجّل التطبيق جهازًا مجهولًا — بلا حساب وبلا دفع. بتشغيلها فأنت توافق على شروط Cloudflare.",
  "warp.terms": "شروط الخدمة",
  "warp.privacy": "سياسة الخصوصية",
  "warp.accept": "أوافق، شغّلها",
  "warp.registerFailed": "تعذّر التسجيل في WARP",
  "warp.linkCopied": "تم نسخ الرابط",
  "warp.account": "حساب Cloudflare",
  "warp.accountOn": "مسجَّل، الخطة {type}",
  "warp.accountOff": "غير مسجَّل — يتم التسجيل عند أول تشغيل لـ WARP",
  "warp.newAddress": "تغيير العنوان",
  "warp.newAddressHint": "تسجيل جديد: مفتاح آخر، وعنوان خروج آخر",
  "warp.resetDone": "أُعيد تسجيل WARP",
  "warp.resetFailed": "تعذّرت إعادة تسجيل WARP",

  // ----------------------------------------------------------------------- qr
  "qr.scan": "قراءة رمز QR:",
  "qr.screen": "الشاشة",
  "qr.file": "ملف",
  "qr.camera": "الكاميرا",
  "qr.title": "رمز QR",
  "qr.hint": "وجّه الكاميرا نحو الرمز — يُقرأ من تلقاء نفسه.",
  "qr.overlayScan": "اقرأ",
  "qr.overlayHint": "افتح الرمز على الشاشة",
  "qr.overlayDone": "تم",
  "qr.starting": "جارٍ تشغيل الكاميرا…",
  "qr.denied": "الوصول إلى الكاميرا مرفوض — اسمح به من إعدادات النظام.",
  "qr.noCamera": "لم يُعثر على كاميرا.",
  "qr.cameraFailed": "تعذّر تشغيل الكاميرا.",
  "qr.switch": "كاميرا أخرى",
  "qr.expand": "توسيع",
  "qr.collapse": "تصغير",
  "qr.foundOne": "تمت قراءة الرمز",
  "qr.foundMany": "الرموز المقروءة: {n}",
  "qr.nothing": "لم يُعثر على رمز QR",
  "qr.screenFailed": "تعذّر التقاط الشاشة",
  "qr.fileFailed": "تعذّرت قراءة الصورة",
