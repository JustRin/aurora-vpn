...
export const en: Record<keyof typeof ru, string> = {
  ...
  "dash.stateUnreachable": "Server not responding",
  "dash.stateReconnecting": "Reconnecting…",
  "dash.unreachableHint":
    "Checks through “{name}” fail and no traffic flows. Check your internet, pick another server or turn on Failover.",
  "dash.unreachableAuto":
    "Checks through the server fail and no traffic flows. The balancer will move traffic as soon as it finds a live server.",
  ...
  "pick.balancers": "Balancers",
  "pick.servers": "Servers",
  "pick.badgeBackup": "backup server",
  "pick.now": "now: {name}",
  "pick.nowChip": "now",
  "pick.primary": "primary: {name}",
  "pick.primaryDown": "primary is down",
  "pick.failoverMeta": "a primary and a stand-in while it is silent",
  "pick.fastestMeta": "by latency, no flapping between equals",
  "pick.rotateMeta": "next live server every round",
  ...
  "srv.pasteBtn": "Paste",
  "srv.clipboardEmpty": "The clipboard holds no text",
  "srv.pasteFailed": "Could not read the clipboard",
  ...
  "srv.warpEndpointHint": "Cloudflare's entry point is the address and port above. If that port is blocked on your network, try 500, 854, 955 or 4500.",

  // --------------------------------------------------------------------- warp
  "warp.title": "Extra security by WARP",
  "warp.desc": "Traffic goes through the chosen server and on through Cloudflare WARP. The server has to carry UDP.",
  "warp.working": "Applying…",
  "warp.enabled": "WARP is on",
  "warp.consentTitle": "Turn on Cloudflare WARP",
  "warp.consentText": "WARP is a free WireGuard service from Cloudflare. The app registers an anonymous device — no account, no payment. By turning it on you agree to Cloudflare's terms.",
  "warp.terms": "Terms of service",
  "warp.privacy": "Privacy policy",
  "warp.accept": "Agree and turn on",
  "warp.registerFailed": "Could not register with WARP",
  "warp.linkCopied": "Link copied",
  "warp.account": "Cloudflare account",
  "warp.accountOn": "registered, {type} plan",
  "warp.accountOff": "not registered — that happens the first time WARP is switched on",
  "warp.newAddress": "New address",
  "warp.newAddressHint": "A fresh registration: another key, and another address on the way out",
  "warp.resetDone": "WARP re-registered",
  "warp.resetFailed": "Could not re-register WARP",
  ...
  "qr.camera": "Camera",
  "qr.title": "QR code",
  "qr.hint": "Point the camera at the code — it is read on its own.",
  "qr.overlayScan": "Scan",
  "qr.overlayHint": "Open the code on screen",
  "qr.overlayDone": "Done",
  "qr.starting": "Starting the camera…",
  "qr.denied": "Camera access is blocked — allow it in the system settings.",
  "qr.noCamera": "No camera found.",
  "qr.cameraFailed": "The camera would not start.",
  "qr.switch": "Another camera",
  "qr.expand": "Expand",
  "qr.collapse": "Collapse",
  "qr.foundOne": "Code read",
  "qr.foundMany": "Codes read: {n}",
  "qr.nothing": "No QR code found",
  "qr.screenFailed": "Failed to capture the screen",
  "qr.fileFailed": "Failed to read the picture",
