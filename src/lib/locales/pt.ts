...
export const pt: Record<keyof typeof ru, string> = {
  ...
  "srv.pasteBtn": "Colar",
  "srv.clipboardEmpty": "A área de transferência não tem texto",
  "srv.pasteFailed": "Não foi possível ler a área de transferência",
  ...
  "srv.warpEndpointHint": "O ponto de entrada da Cloudflare é o endereço e a porta acima. Se essa porta estiver bloqueada na sua rede, tente 500, 854, 955 ou 4500.",

  // --------------------------------------------------------------------- warp
  "warp.title": "Proteção extra pelo WARP",
  "warp.desc": "O tráfego passa pelo servidor escolhido e segue pelo Cloudflare WARP. O servidor precisa transportar UDP.",
  "warp.working": "Aplicando…",
  "warp.enabled": "WARP ligado",
  "warp.consentTitle": "Ligar o Cloudflare WARP",
  "warp.consentText": "O WARP é um WireGuard gratuito da Cloudflare. O app registra um dispositivo anônimo — sem conta e sem pagamento. Ao ligar, você concorda com os termos da Cloudflare.",
  "warp.terms": "Termos de serviço",
  "warp.privacy": "Política de privacidade",
  "warp.accept": "Concordo, ligar",
  "warp.registerFailed": "Não foi possível registrar no WARP",
  "warp.linkCopied": "Link copiado",
  "warp.account": "Conta Cloudflare",
  "warp.accountOn": "registrada, plano {type}",
  "warp.accountOff": "sem registro — ele acontece ao ligar o WARP pela primeira vez",
  "warp.newAddress": "Trocar endereço",
  "warp.newAddressHint": "Um novo registro: outra chave e outro endereço na saída",
  "warp.resetDone": "WARP registrado de novo",
  "warp.resetFailed": "Não foi possível registrar o WARP de novo",

  // ----------------------------------------------------------------------- qr
  "qr.scan": "Ler um código QR:",
  "qr.screen": "Tela",
  "qr.file": "Arquivo",
  "qr.camera": "Câmera",
  "qr.title": "Código QR",
  "qr.hint": "Aponte a câmera para o código — ele é lido sozinho.",
  "qr.overlayScan": "Ler",
  "qr.overlayHint": "Abra o código na tela",
  "qr.overlayDone": "Pronto",
  "qr.starting": "Ligando a câmera…",
  "qr.denied": "Acesso à câmera negado — permita-o nas configurações do sistema.",
  "qr.noCamera": "Nenhuma câmera encontrada.",
  "qr.cameraFailed": "Não foi possível ligar a câmera.",
  "qr.switch": "Outra câmera",
  "qr.expand": "Expandir",
  "qr.collapse": "Recolher",
  "qr.foundOne": "Código lido",
  "qr.foundMany": "Códigos lidos: {n}",
  "qr.nothing": "Nenhum código QR encontrado",
  "qr.screenFailed": "Não foi possível capturar a tela",
  "qr.fileFailed": "Não foi possível ler a imagem",
