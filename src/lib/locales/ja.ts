...
export const ja: Record<keyof typeof ru, string> = {
  ...
  "srv.warpEndpointHint": "Cloudflare の接続先は上のアドレスとポートです。そのポートが塞がれている場合は 500、854、955、4500 を試してください。",

  // --------------------------------------------------------------------- warp
  "warp.title": "WARP による追加の保護",
  "warp.desc": "通信は選んだサーバーを経由し、さらに Cloudflare WARP を通ります。サーバーが UDP を通せることが必要です。",
  "warp.working": "適用中…",
  "warp.enabled": "WARP を有効にしました",
  "warp.consentTitle": "Cloudflare WARP を有効にする",
  "warp.consentText": "WARP は Cloudflare が無料で提供する WireGuard です。アプリは匿名の端末を登録します — アカウントも支払いも不要です。有効にすると Cloudflare の規約に同意したことになります。",
  "warp.terms": "利用規約",
  "warp.privacy": "プライバシーポリシー",
  "warp.accept": "同意して有効にする",
  "warp.registerFailed": "WARP の登録に失敗しました",
  "warp.linkCopied": "リンクをコピーしました",
  "warp.account": "Cloudflare アカウント",
  "warp.accountOn": "登録済み・{type} プラン",
  "warp.accountOff": "未登録 — WARP を初めて有効にしたときに登録されます",
  "warp.newAddress": "アドレスを変更",
  "warp.newAddressHint": "登録し直します。鍵が変わり、出口のアドレスも変わります",
  "warp.resetDone": "WARP を登録し直しました",
  "warp.resetFailed": "WARP を登録し直せませんでした",
