...
export const ja: Record<keyof typeof ru, string> = {
  ...
  "srv.importBtn": "取り込む",
  "srv.pasteBtn": "貼り付け",
  "srv.clipboardEmpty": "クリップボードにテキストがありません",
  "srv.pasteFailed": "クリップボードを読み取れませんでした",
  "srv.linksLabel": "リンク",
  "srv.linksHint":
  ...
  "qr.camera": "カメラ",
  "qr.title": "QR コード",
  "qr.hint": "カメラをコードに向けると、自動で読み取ります。",
  "qr.overlayScan": "読み取る",
  "qr.overlayHint": "画面にコードを表示してください",
  "qr.overlayDone": "完了",
  "qr.starting": "カメラを起動しています…",
  "qr.denied": "カメラへのアクセスが拒否されています。システム設定で許可してください。",
  "qr.noCamera": "カメラが見つかりません。",
  "qr.cameraFailed": "カメラを起動できませんでした。",
  "qr.switch": "別のカメラ",
  "qr.expand": "拡大",
  "qr.collapse": "元に戻す",
  "qr.foundOne": "コードを読み取りました",
  "qr.foundMany": "読み取ったコード: {n} 件",
  "qr.nothing": "QR コードが見つかりません",
  "qr.screenFailed": "画面を取得できませんでした",
  "qr.fileFailed": "画像を読み取れませんでした",
