...
> антивируса: «Подробнее» → «Выполнить в любом случае». Убирается только
> подписью (SignPath для OSS / Azure Trusted Signing / OV-сертификат) — след
> в issues, если возьмёмся.
