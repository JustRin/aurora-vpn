...
| `settings.png` | Settings, palettes visible | gallery, bottom right |

Guidelines that keep the card looking consistent:

- **Same window size everywhere** — the gallery puts the shots side by side, so
  differing sizes are immediately visible. The default window size is fine;
...
| `settings.png` | Настройки, видны палитры | галерея, справа внизу |
